...
import cv2
import random
import Seguimiento_Mano as sm  # Clase manos
import os
import imutils
...
detector = sm.detector_manos(Confdeteccion=0.9)
...
while True:
    ...
    # Posiciones mano 1
    lista1, bbox1, jug = detector.encontrar_posicion(
        frame, ManoNum=0, dibujar=True, color=[0, 255, 0]
    )
    ...
    # 2 Jugadores
        ...
        lista2, bbox2, jug2 = detector.encontrar_posicion(
            frame, ManoNum=1, dibujar=True, color=[255, 0, 0]
        )
