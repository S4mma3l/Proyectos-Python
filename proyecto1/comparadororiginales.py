...
df_CSV_1 = pd.DataFrame(array1, columns=["CRID", "1st Name", "Last Name"])
df_CSV_2 = pd.DataFrame(array2, columns=["CRID", "1st Name", "Last Name"])
...
#df_CSV_1.eq(df_CSV_2).to_excel("pruebao.xlsx")